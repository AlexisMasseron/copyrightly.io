Feature: Manifest Single Authorship
  ...
  Scenario: Register a piece of content not previously registered
    ...
    And I fill the form with title "A nice picture" and content hash "QmYwAPJzv5CZsnA625s3Xf2nemtYgPpHdWEz79ojWnPbdG"
  ...
  Scenario: Register a piece of content previously registered
    ...
    When I click submenu option "Register" in menu "Registry"
    And I fill the form with title "My nice picture" and content hash "QmYwAPJzv5CZsnA625s3Xf2nemtYgPpHdWEz79ojWnPbdG"
    And I click the "Register" button
